...
public class DokterFrame extends javax.swing.JFrame {  
   ...
   private String user = "root";
    ...
    private void initComponents() {
        ...
        txtnotlp.getAccessibleContext().setAccessibleName("txtno.tlp");
    ...
    new configDB().saveAnggota(txtemail.getText(),txtid.getText(), txtnama.getText(), txtnotlp.getText());
